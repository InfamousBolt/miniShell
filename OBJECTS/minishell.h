...
/*   Updated: 2022/02/20 18:54:20 by keshav           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		clean_up_and_exit(t_instructions instructions,
				bool global, bool ext);

//get_io_files.c
char		**get_io(char *s);
void		allocate_io(char ***io);
void		get_redirection(char *s, char **io, char **io_err, bool combined);
void		get_input_redirection(char *s, char **io,
				char **io_err, bool combined);
...
int			check_redirection_extended(char *s, char *err,
				int str_len, int error);
